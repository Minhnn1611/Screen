...
static void screen_imgbtn_14_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        ui_animation(guider_ui.screen_win_1, 1000, 0, lv_obj_get_x(guider_ui.screen_win_1), 490, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_x, NULL, NULL, NULL);
        ui_animation(guider_ui.screen_win_1, 1000, 0, lv_obj_get_y(guider_ui.screen_win_1), 0, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        break;
    }
    default:
        break;
...
static void screen_win_1_item0_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        ui_animation(guider_ui.screen_win_1, 1000, 0, lv_obj_get_x(guider_ui.screen_win_1), 810, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_x, NULL, NULL, NULL);
        ui_animation(guider_ui.screen_win_1, 1000, 0, lv_obj_get_y(guider_ui.screen_win_1), 0, &lv_anim_path_linear, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        break;
    }
    default:
