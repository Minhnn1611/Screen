...
#define GENERATED_ATTRIBUTES { \
  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)3  } }, /* 0 Cluster: Basic, Attribute: cluster revision, Side: client*/ \
	  ...
	  { 0x0022, ZCL_SECURITY_KEY_ATTRIBUTE_TYPE, 16, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_CLIENT), { (uint8_t*)&(generatedDefaults[6]) } }, /* 30 Cluster: Green Power, Attribute: gp link key, Side: client*/ \
	  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 31 Cluster: Green Power, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 32 Cluster: Color Control, Attribute: cluster revision, Side: client*/ \
		  { 0x0002, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 33 Cluster: Color Control, Attribute: remaining time, Side: server*/ \
		  { 0x0003, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x616B  } }, /* 34 Cluster: Color Control, Attribute: current x, Side: server*/ \
		  { 0x0004, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x607D  } }, /* 35 Cluster: Color Control, Attribute: current y, Side: server*/ \
		  { 0x0008, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 36 Cluster: Color Control, Attribute: color mode, Side: server*/ \
		  { 0x000F, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0x00  } }, /* 37 Cluster: Color Control, Attribute: color control options, Side: server*/ \
		  { 0x0010, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 38 Cluster: Color Control, Attribute: number of primaries, Side: server*/ \
		  { 0x4001, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 39 Cluster: Color Control, Attribute: enhanced color mode, Side: server*/ \
		  { 0x400A, ZCL_BITMAP16_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 40 Cluster: Color Control, Attribute: color capabilities, Side: server*/ \
		  { 0x400B, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 41 Cluster: Color Control, Attribute: color temp physical min, Side: server*/ \
		  { 0x400C, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0xFEFF  } }, /* 42 Cluster: Color Control, Attribute: color temp physical max, Side: server*/ \
		  { 0x400D, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 43 Cluster: Color Control, Attribute: couple color temp to level min-mireds, Side: server*/ \
		  { 0x4010, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0x00  } }, /* 44 Cluster: Color Control, Attribute: start up color temperature mireds, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)3  } }, /* 45 Cluster: Color Control, Attribute: cluster revision, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 46 Cluster: Illuminance Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 47 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 48 Cluster: Relative Humidity Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 49 Cluster: Occupancy Sensing, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 50 Cluster: IAS Zone, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 51 Cluster: Simple Metering, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 52 Cluster: Meter Identification, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 53 Cluster: Appliance Statistics, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } } /* 54 Cluster: Electrical Measurement, Attribute: cluster revision, Side: client*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 1, 0, CLUSTER_MASK_CLIENT, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: client*/ \
	  ...
	  { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[32]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 14, Endpoint Id: 1, Cluster: Color Control, Side: client*/ \
	  { 0x0300, (EmberAfAttributeMetadata*)&(generatedAttributes[33]), 13, 22, CLUSTER_MASK_SERVER, NULL }, /* 15, Endpoint Id: 1, Cluster: Color Control, Side: server*/ \
	  { 0x0400, (EmberAfAttributeMetadata*)&(generatedAttributes[46]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 16, Endpoint Id: 1, Cluster: Illuminance Measurement, Side: client*/ \
	  { 0x0402, (EmberAfAttributeMetadata*)&(generatedAttributes[47]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 17, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0405, (EmberAfAttributeMetadata*)&(generatedAttributes[48]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 18, Endpoint Id: 1, Cluster: Relative Humidity Measurement, Side: client*/ \
	  { 0x0406, (EmberAfAttributeMetadata*)&(generatedAttributes[49]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 19, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x0500, (EmberAfAttributeMetadata*)&(generatedAttributes[50]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 20, Endpoint Id: 1, Cluster: IAS Zone, Side: client*/ \
	  { 0x0702, (EmberAfAttributeMetadata*)&(generatedAttributes[51]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 21, Endpoint Id: 1, Cluster: Simple Metering, Side: client*/ \
	  { 0x0B01, (EmberAfAttributeMetadata*)&(generatedAttributes[52]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 22, Endpoint Id: 1, Cluster: Meter Identification, Side: client*/ \
	  { 0x0B03, (EmberAfAttributeMetadata*)&(generatedAttributes[53]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 23, Endpoint Id: 1, Cluster: Appliance Statistics, Side: client*/ \
	  { 0x0B04, (EmberAfAttributeMetadata*)&(generatedAttributes[54]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 24, Endpoint Id: 1, Cluster: Electrical Measurement, Side: client*/ \
	  { 0x0021, (EmberAfAttributeMetadata*)&(generatedAttributes[26]), 6, 278, CLUSTER_MASK_CLIENT, NULL } /* 25, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	 }
...
#define GENERATED_ENDPOINT_TYPES { \
  { ((EmberAfCluster*)&(generatedClusters[0])), 25, 73 }, \
	  { ((EmberAfCluster*)&(generatedClusters[25])), 1, 278 }, \
	 } 
